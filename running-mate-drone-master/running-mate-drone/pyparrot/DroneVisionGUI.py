...
class DroneVisionGUI:
    def __init__(self, drone_object, is_bebop, model, user_code_to_run, user_args, buffer_size=200, network_caching=200, fps=20, user_draw_window_fn=None):
        
        """
        Setup your vision object and initialize your buffers.  You won't start seeing pictures
        until you call open_video.
        :param drone_object referen3ce to the drone (mambo or bebop) object
